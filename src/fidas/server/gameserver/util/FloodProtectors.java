...
public final class FloodProtectors
{
	...
	/**
	 * VIP-chat flood protector.
	 */
	private final FloodProtectorAction _vipChat;
	/**
	...
	public FloodProtectors(final L2GameClient client)
	{
		...
		_vipChat = new FloodProtectorAction(client, Config.FLOOD_PROTECTOR_VIP_CHAT);
	...
	/**
	 * Returns {@link #_vipChat}.
	 * @return {@link #_vipChat}
	 */
	public FloodProtectorAction getVipChat()
	{
		return _vipChat;
	}
