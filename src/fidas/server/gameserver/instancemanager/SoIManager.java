...
public class SoIManager
{
	...
	public static void closeSeed()
	{
		...
		fidas.server.gameserver.scripts.data.EnergySeeds.SoiSeedStop();
	...
	{
		fidas.server.gameserver.scripts.data.EnergySeeds.SoiCloseMouthStop();
		fidas.server.gameserver.scripts.data.EnergySeeds.SoiMouthStop();
		fidas.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Stop();
		fidas.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze1Stop();
		switch (getCurrentStage())
		{
			case 1:
			case 4:
				fidas.server.gameserver.scripts.data.EnergySeeds.SoiMouthSpawn();
				fidas.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Spawn();
				break;
			case 5:
				fidas.server.gameserver.scripts.data.EnergySeeds.SoiCloseMouthSpawn();
				fidas.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Spawn();
				break;
			default:
				fidas.server.gameserver.scripts.data.EnergySeeds.SoiCloseMouthSpawn();
				fidas.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze1Spawn();
				break;
		}
	}
	...
	{
		fidas.server.gameserver.scripts.data.EnergySeeds.SoiSeedSpawn();
	}
