package fidas.server.gameserver.instancemanager;
...
import fidas.server.gameserver.model.zone.AbstractZoneSettings;
import fidas.server.gameserver.model.zone.L2ZoneRespawn;
import fidas.server.gameserver.model.zone.L2ZoneType;
import fidas.server.gameserver.model.zone.form.ZoneCuboid;
import fidas.server.gameserver.model.zone.form.ZoneCylinder;
import fidas.server.gameserver.model.zone.form.ZoneNPoly;
import fidas.server.gameserver.model.zone.type.L2ArenaZone;
import fidas.server.gameserver.model.zone.type.L2OlympiadStadiumZone;
import fidas.server.gameserver.model.zone.type.L2RespawnZone;
			...
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("zone".equalsIgnoreCase(d.getNodeName()))
					{
						...
						try
						{
							newZone = Class.forName("fidas.server.gameserver.model.zone.type.L2" + zoneType);
