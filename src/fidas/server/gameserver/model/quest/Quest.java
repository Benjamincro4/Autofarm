 ...
 */
package fidas.server.gameserver.model.quest;
...
import fidas.server.gameserver.model.actor.instance.L2DoorInstance;
...
import fidas.server.gameserver.model.actor.instance.L2TrapInstance;
...
import fidas.server.gameserver.model.interfaces.IL2Procedure;
...
import fidas.server.gameserver.model.olympiad.CompetitionType;
import fidas.server.gameserver.model.quest.AITasks.AggroRangeEnter;
import fidas.server.gameserver.model.quest.AITasks.SeeCreature;
import fidas.server.gameserver.model.quest.AITasks.SkillSee;
...
import fidas.server.gameserver.network.NpcStringId;
...
import fidas.server.gameserver.network.serverpackets.NpcQuestHtmlMessage;
...
import fidas.server.gameserver.scripting.ManagedScript;
import fidas.server.gameserver.scripting.ScriptManager;
import fidas.server.gameserver.util.MinionList;
import fidas.server.util.L2FastMap;
import fidas.server.util.Rnd;
import fidas.server.util.Util;
...
public class Quest extends ManagedScript
{
	 ...
	 * Use this method instead of importing {@link fidas.server.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link fidas.server.gameserver.GameTimeController}.
	 */
