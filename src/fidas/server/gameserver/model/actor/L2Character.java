 ...
 */
package fidas.server.gameserver.model.actor;

import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import fidas.server.gameserver.ai.CtrlEvent;
import fidas.server.gameserver.ai.CtrlIntention;
import fidas.server.gameserver.ai.L2AttackableAI;
...
import fidas.server.gameserver.handler.ISkillHandler;
import fidas.server.gameserver.handler.SkillHandler;
...
import fidas.server.gameserver.instancemanager.MapRegionManager.TeleportWhereType;
import fidas.server.gameserver.instancemanager.TerritoryWarManager;
import fidas.server.gameserver.instancemanager.TownManager;
import fidas.server.gameserver.model.ChanceSkillList;
import fidas.server.gameserver.model.CharEffectList;
import fidas.server.gameserver.model.FusionSkill;
...
import fidas.server.gameserver.model.actor.instance.L2NpcInstance;
import fidas.server.gameserver.model.actor.instance.L2NpcWalkerInstance;
import fidas.server.gameserver.model.actor.instance.L2PcInstance;
import fidas.server.gameserver.model.actor.instance.L2PcInstance.SkillDat;
import fidas.server.gameserver.model.actor.instance.L2PetInstance;
import fidas.server.gameserver.model.actor.instance.L2RiftInvaderInstance;
import fidas.server.gameserver.model.actor.knownlist.CharKnownList;
import fidas.server.gameserver.model.actor.position.CharPosition;
import fidas.server.gameserver.model.actor.stat.CharStat;
import fidas.server.gameserver.model.actor.status.CharStatus;
import fidas.server.gameserver.model.actor.templates.L2CharTemplate;
import fidas.server.gameserver.model.actor.templates.L2NpcTemplate;
...
import fidas.server.gameserver.model.holders.SkillHolder;
import fidas.server.gameserver.model.interfaces.IChanceSkillTrigger;
import fidas.server.gameserver.model.interfaces.ISkillsHolder;
...
import fidas.server.gameserver.model.skills.funcs.Func;
import fidas.server.gameserver.model.skills.l2skills.L2SkillMount;
...
import fidas.server.gameserver.model.stats.BaseStats;
import fidas.server.gameserver.model.stats.Calculator;
...
import fidas.server.gameserver.network.serverpackets.AbstractNpcInfo;
import fidas.server.gameserver.network.serverpackets.ActionFailed;
import fidas.server.gameserver.network.serverpackets.Attack;
import fidas.server.gameserver.network.serverpackets.ChangeMoveType;
import fidas.server.gameserver.network.serverpackets.ChangeWaitType;
import fidas.server.gameserver.network.serverpackets.FlyToLocation;
import fidas.server.gameserver.network.serverpackets.FlyToLocation.FlyType;
import fidas.server.gameserver.network.serverpackets.L2GameServerPacket;
import fidas.server.gameserver.network.serverpackets.MagicSkillCanceld;
import fidas.server.gameserver.network.serverpackets.MagicSkillLaunched;
import fidas.server.gameserver.network.serverpackets.MagicSkillUse;
import fidas.server.gameserver.network.serverpackets.MoveToLocation;
import fidas.server.gameserver.network.serverpackets.Revive;
import fidas.server.gameserver.network.serverpackets.ServerObjectInfo;
...
import fidas.server.gameserver.network.serverpackets.TeleportToLocation;
import fidas.server.gameserver.pathfinding.AbstractNodeLoc;
...
import fidas.server.gameserver.util.L2TIntObjectHashMap;
