...
import fidas.server.gameserver.model.clientstrings.Builder;
...
public final class SystemMessageId
{
	...
	/**
	 * ID: 7000<br>
	 * Message: You have received VIP reward $s2 $s1(s).
	 */
	public static final SystemMessageId REWARD_VIP_S2_S1_S;
	
	/**
	 * ID: 7001<br>
	 * Message: You have received VIP reward $s1.
	 */
	public static final SystemMessageId REWARD_VIP_ITEM_S1;
	...
	static
	{
		...
		REWARD_VIP_S2_S1_S = new SystemMessageId(7000);
		REWARD_VIP_ITEM_S1 = new SystemMessageId(7001);
