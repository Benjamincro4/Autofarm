 ...
 */
package fidas.server.gameserver.network;
...
import fidas.server.gameserver.LoginServerThread.SessionKey;
...
import fidas.server.gameserver.security.SecondaryPasswordAuth;
		...
		public void run()
		{
			try
			{
				...
				if (getActiveChar() != null) // this should only happen on connection loss
				{
					...
					{
					    final L2GameClient client = getActiveChar().getClient();
