...
public final class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		// y luego el resto en su sitio
		writeD(DressMeService.visual(_activeChar, Inventory.PAPERDOLL_GLOVES,
		        _activeChar.getInventory().getPaperdollItemDisplayId(Inventory.PAPERDOLL_GLOVES)));

		writeD(DressMeService.visual(_activeChar, Inventory.PAPERDOLL_CHEST,
		        _activeChar.getInventory().getPaperdollItemDisplayId(Inventory.PAPERDOLL_CHEST)));

		writeD(DressMeService.visual(_activeChar, Inventory.PAPERDOLL_LEGS,
		        _activeChar.getInventory().getPaperdollItemDisplayId(Inventory.PAPERDOLL_LEGS)));

		writeD(DressMeService.visual(_activeChar, Inventory.PAPERDOLL_FEET,
		        _activeChar.getInventory().getPaperdollItemDisplayId(Inventory.PAPERDOLL_FEET)));
