 ...
 */
package fidas.server.gameserver.scripting.scriptengine.impl;
...
import fidas.server.gameserver.scripting.scriptengine.events.AddToInventoryEvent;
import fidas.server.gameserver.scripting.scriptengine.events.AttackEvent;
import fidas.server.gameserver.scripting.scriptengine.events.AugmentEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ChatEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanCreationEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanJoinEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanLeaderChangeEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanLeaveEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanLevelUpEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanWarEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanWarehouseAddItemEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanWarehouseDeleteItemEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ClanWarehouseTransferEvent;
import fidas.server.gameserver.scripting.scriptengine.events.DeathEvent;
import fidas.server.gameserver.scripting.scriptengine.events.DlgAnswerEvent;
import fidas.server.gameserver.scripting.scriptengine.events.EquipmentEvent;
import fidas.server.gameserver.scripting.scriptengine.events.FortSiegeEvent;
import fidas.server.gameserver.scripting.scriptengine.events.HennaEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ItemCreateEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ItemDestroyEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ItemDropEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ItemPickupEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ItemTransferEvent;
import fidas.server.gameserver.scripting.scriptengine.events.PlayerEvent;
import fidas.server.gameserver.scripting.scriptengine.events.PlayerLevelChangeEvent;
import fidas.server.gameserver.scripting.scriptengine.events.ProfessionChangeEvent;
import fidas.server.gameserver.scripting.scriptengine.events.RequestBypassToServerEvent;
import fidas.server.gameserver.scripting.scriptengine.events.SiegeEvent;
import fidas.server.gameserver.scripting.scriptengine.events.SkillUseEvent;
import fidas.server.gameserver.scripting.scriptengine.events.TransformEvent;
import fidas.server.gameserver.scripting.scriptengine.events.TvtKillEvent;
import fidas.server.gameserver.scripting.scriptengine.events.impl.L2Event;
import fidas.server.gameserver.scripting.scriptengine.listeners.character.AttackListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.character.DeathListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.character.SkillUseListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.clan.ClanCreationListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.clan.ClanMembershipListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.clan.ClanWarListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.clan.ClanWarehouseListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.events.FortSiegeListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.events.SiegeListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.events.TvTListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.player.AugmentListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.player.DropListener;
...
import fidas.server.gameserver.scripting.scriptengine.listeners.player.ItemTracker;
import fidas.server.gameserver.scripting.scriptengine.listeners.player.NewItemListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.player.PlayerDespawnListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.player.PlayerLevelListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.player.PlayerListener;
...
import fidas.server.gameserver.scripting.scriptengine.listeners.talk.ChatFilterListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.talk.ChatListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.talk.DlgAnswerListener;
import fidas.server.gameserver.scripting.scriptengine.listeners.talk.RequestBypassToServerListener;
...
public abstract class L2Script extends Quest
{
	...
	{
	    DiscordRichPresenceManager.updatePresence("Jugando a L2Fidas.com", "Bienvenido " + player.getName());
	}
	...
	{
	    DiscordRichPresenceManager.updatePresence("Jugando a L2Fidas.com", "Esperando jugadores...");
	}
