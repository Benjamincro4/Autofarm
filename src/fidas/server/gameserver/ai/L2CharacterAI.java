...
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_CAST;
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE;
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_INTERACT;
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_MOVE_TO;
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_PICK_UP;
import static fidas.server.gameserver.ai.CtrlIntention.AI_INTENTION_REST;
...
import fidas.server.gameserver.model.actor.FakePc;
...
import fidas.server.gameserver.model.items.instance.L2ItemInstance.ItemLocation;
...
import fidas.server.gameserver.network.serverpackets.AutoAttackStop;
