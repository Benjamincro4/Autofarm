package fidas.server.gameserver.taskmanager;

import static fidas.server.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static fidas.server.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static fidas.server.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import fidas.server.gameserver.taskmanager.tasks.SoIStageUpdater;
import fidas.server.gameserver.taskmanager.tasks.TaskBirthday;
import fidas.server.gameserver.taskmanager.tasks.TaskCleanUp;
import fidas.server.gameserver.taskmanager.tasks.TaskDailySkillReuseClean;
import fidas.server.gameserver.taskmanager.tasks.TaskGlobalVariablesSave;
import fidas.server.gameserver.taskmanager.tasks.TaskJython;
import fidas.server.gameserver.taskmanager.tasks.TaskOlympiadSave;
import fidas.server.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import fidas.server.gameserver.taskmanager.tasks.TaskRecom;
import fidas.server.gameserver.taskmanager.tasks.TaskRestart;
import fidas.server.gameserver.taskmanager.tasks.TaskScript;
import fidas.server.gameserver.taskmanager.tasks.TaskSevenSignsUpdate;
import fidas.server.gameserver.taskmanager.tasks.TaskShutdown;
