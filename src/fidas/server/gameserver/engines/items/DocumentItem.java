 ...
 */
package fidas.server.gameserver.engines.items;
...
import fidas.server.gameserver.engines.DocumentBase;
...
public final class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			Constructor<?> c = Class.forName("fidas.server.gameserver.model.items.L2" + _currentItem.type).getConstructor(StatsSet.class);
