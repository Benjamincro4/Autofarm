 ...
 */
package fidas.server.tools.dbinstaller.console;

import java.sql.Connection;
import java.util.Scanner;
import java.util.prefs.Preferences;

import fidas.server.tools.dbinstaller.DBOutputInterface;
import fidas.server.tools.dbinstaller.RunTasks;
import fidas.server.tools.dbinstaller.util.mysql.MySqlConnect;
import fidas.server.util.CloseShieldedInputStream;
