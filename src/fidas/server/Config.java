...
import fidas.server.gameserver.engines.DocumentParser;
import fidas.server.gameserver.model.holders.ItemHolder;
import fidas.server.gameserver.model.itemcontainer.PcInventory;
import fidas.server.gameserver.util.FloodProtectorConfig;
import fidas.server.gameserver.util.Util;
import fidas.server.util.L2Properties;
import fidas.server.util.StringUtil;
...
public final class Config
{
	...
	public static final String AUTO_RESTART = "./config/AutoRestartGameServer.properties";
	...
	public static final String L2Fidas_FILE = "./config/L2Fidas.properties";
	...
	public static int GLOBAL_CHAT_MIN_LEVEL;
	public static int TRADE_CHAT_MIN_LEVEL;
	...
	public static FloodProtectorConfig FLOOD_PROTECTOR_VIP_CHAT;
	...
	public static boolean ALLOW_VIP_EXP_SP;
	public static boolean ALLOW_VIP_DROP;
	public static boolean ALLOW_VIP_ADENA;
	public static boolean ALLOW_VIP_SPOIL;

	public static float VIP_XP;
	public static float VIP_SP;
	public static float VIP_ADENA;
	public static float VIP_DROP;
	public static float VIP_SPOIL;
	public static float VIPPLUS_SPOIL;
    ...
    //create macro newbie
    public static String CREATE_NEWBIE_MACRO;
    
    // DressMe Colors
    public static int DRESSME_COLOR_COIN_ID;
    public static long DRESSME_NAME_COLOR_PRICE;
    public static long DRESSME_TITLE_COLOR_PRICE;
    public static String DRESSME_COLORS;
    public static String DRESSME_FREE_COLORS;
    
    // DressMe Armor
    public static int DRESSME_ARMOR_COIN_ID;
    public static long DRESSME_ARMOR_PRICE;
    
    // DressMe Sex
    public static int DRESSME_SEX_COIN_ID;
    public static long DRESSME_SEX_PRICE;

    // DressMe Name
    public static int DRESSME_NAME_CHANGE_COIN_ID;
    public static long DRESSME_NAME_CHANGE_PRICE;
	...
	public static boolean OFFLINE_MODE_IN_PACE_ZONE;
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			FLOOD_PROTECTOR_VIP_CHAT = new FloodProtectorConfig("VipChatFloodProtector");
			...
			// L2Fidas Custom Config
			L2Properties FidasSettings = new L2Properties();
			final File L2Fidas = new File(L2Fidas_FILE);
			try (InputStream is = new FileInputStream(L2Fidas))
			{
				FidasSettings.load(is);
				FENCE_MOVIE_BUILDER = Boolean.parseBoolean(FidasSettings.getProperty("AllowFenceBuild", "false"));
				CLAN_LEADER_COLOR_ENABLED = Boolean.parseBoolean(FidasSettings.getProperty("ClanLeaderNameColorEnabled", "True"));
				CLAN_LEADER_COLOR = Integer.decode((new StringBuilder()).append("0x").append(FidasSettings.getProperty("ClanLeaderColor", "00FFFF")).toString()).intValue();
				CLAN_LEADER_COLOR_CLAN_LEVEL = Integer.parseInt(FidasSettings.getProperty("ClanLeaderColorAtClanLevel", "1"));
				ANNOUNCE_CASTLE_LORDS = Boolean.parseBoolean(FidasSettings.getProperty("AnnounceCastleLords", "True"));
				SHOW_ONLINE_PLAYERS_ON_LOGIN = Boolean.parseBoolean(FidasSettings.getProperty("ShowOnlinePlayersOnLogin", "True"));
				// Clan Full 
				ENABLE_CLAN_SYSTEM = Boolean.parseBoolean(FidasSettings.getProperty("EnableClanSystem", "True")); 
				if(ENABLE_CLAN_SYSTEM) 
				{ 
				String AioSkillsSplit[] = FidasSettings.getProperty("ClanSkills", "").split(";"); 
				...
				CLAN_LEVEL = Byte.parseByte(FidasSettings.getProperty("ClanSetLevel", "8")); 
				REPUTATION_QUANTITY = Integer.parseInt(FidasSettings.getProperty("ReputationScore", "10000"));
				//Shots Infinitos: SS, BSS e flechas 
				INFINITE_SOUL_SHOT = Boolean.parseBoolean(FidasSettings.getProperty("InfiniteSoulShot", "False")); 
				INFINITE_SPIRIT_SHOT = Boolean.parseBoolean(FidasSettings.getProperty("InfiniteSpiritShot", "False")); 
				INFINITE_BLESSED_SPIRIT_SHOT = Boolean.parseBoolean(FidasSettings.getProperty("InfiniteBlessedSpiritShot", "False")); 
				INFINITE_ARROWS = Boolean.parseBoolean(FidasSettings.getProperty("InfiniteArrows", "false"));
				DAGGER_VS_HEAVY = Float.parseFloat(FidasSettings.getProperty("DaggerVsHeavy", "1.00"));
				DAGGER_VS_LIGHT = Float.parseFloat(FidasSettings.getProperty("DaggerVsLight", "1.00"));
				DAGGER_VS_ROBE = Float.parseFloat(FidasSettings.getProperty("DaggerVsRobe", "1.00"));
				ARCHER_VS_HEAVY = Float.parseFloat(FidasSettings.getProperty("ArcherVsHeavy", "1.00"));
				ARCHER_VS_LIGHT = Float.parseFloat(FidasSettings.getProperty("ArcherVsLight", "1.00"));
				ARCHER_VS_ROBE = Float.parseFloat(FidasSettings.getProperty("ArcherVsRobe", "1.00"));
				BLUNT_VS_HEAVY = Float.parseFloat(FidasSettings.getProperty("BluntVsHeavy", "1.00"));
				BLUNT_VS_LIGHT = Float.parseFloat(FidasSettings.getProperty("BluntVsLight", "1.00"));
				BLUNT_VS_ROBE = Float.parseFloat(FidasSettings.getProperty("BluntVsRobe", "1.00"));
				FIST_VS_HEAVY = Float.parseFloat(FidasSettings.getProperty("FistVsHeavy", "1.00"));
				FIST_VS_LIGHT = Float.parseFloat(FidasSettings.getProperty("FistVsLight", "1.00"));
				FIST_VS_ROBE = Float.parseFloat(FidasSettings.getProperty("FistVsRobe", "1.00"));
				DUAL_VS_HEAVY = Float.parseFloat(FidasSettings.getProperty("DualVsHeavy", "1.00"));
				DUAL_VS_LIGHT = Float.parseFloat(FidasSettings.getProperty("DualVsLight", "1.00"));
				DUAL_VS_ROBE = Float.parseFloat(FidasSettings.getProperty("DualVsRobe", "1.00"));
				SWORD_VS_HEAVY = Float.parseFloat(FidasSettings.getProperty("SwordVsHeavy", "1.00"));
				SWORD_VS_LIGHT = Float.parseFloat(FidasSettings.getProperty("SwordVsLight", "1.00"));
				SWORD_VS_ROBE = Float.parseFloat(FidasSettings.getProperty("SwordVsRobe", "1.00"));
				POLE_VS_HEAVY = Float.parseFloat(FidasSettings.getProperty("PoleVsHeavy", "1.00"));
				POLE_VS_LIGHT = Float.parseFloat(FidasSettings.getProperty("PoleVsLight", "1.00"));
				POLE_VS_ROBE = Float.parseFloat(FidasSettings.getProperty("PoleVsRobe", "1.00"));
				PC_BANG_ENABLED = Boolean.parseBoolean(FidasSettings.getProperty("Enabled", "false"));
				ALT_ALLOW_REFINE_PVP_ITEM = Boolean.parseBoolean(FidasSettings.getProperty("AltAllowRefinePVPItem", "False"));
				ENABLE_UNSTUCK_PVP = Boolean.parseBoolean(FidasSettings.getProperty("EnableUnstuckPvP", "True"));
				USE_CR_ITEM = Boolean.parseBoolean(FidasSettings.getProperty("EnableTheClanRepPointsItem", "False"));
				CR_ITEM_MIN_CLAN_LVL = Integer.parseInt(FidasSettings.getProperty("MinClanLevelNeededForCR", "7"));
				CR_ITEM_REPS_TO_BE_AWARDED = Integer.parseInt(FidasSettings.getProperty("HowManyClanRepsToGive", "500"));
				CR_ITEM_REPS_ITEM_ID = Integer.parseInt(FidasSettings.getProperty("CRItemID", "6673"));
				NOBLE_CUSTOM_ITEMS = Boolean.parseBoolean(FidasSettings.getProperty("EnableNobleCustomItem", "true"));
				NOOBLE_CUSTOM_ITEM_ID = Integer.parseInt(FidasSettings.getProperty("NoobleCustomItemId", "6673"));
				GAME_POINT_ITEM_ID = Integer.parseInt(FidasSettings.getProperty("GamePointItemId", "-300"));
				NpcBuffer_Reload = Boolean.parseBoolean(FidasSettings.getProperty("EnableReloadScript", "False"));
				NpcBuffer_SmartWindow = Boolean.parseBoolean(FidasSettings.getProperty("EnableSmartWindow", "True"));
				NpcBuffer_VIP = Boolean.parseBoolean(FidasSettings.getProperty("EnableVIP", "False"));
				NpcBuffer_VIP_ALV = Integer.parseInt(FidasSettings.getProperty("VipAccesLevel", "1"));
				NpcBuffer_EnableBuff = Boolean.parseBoolean(FidasSettings.getProperty("EnableBuffSection", "True"));
				NpcBuffer_EnableScheme = Boolean.parseBoolean(FidasSettings.getProperty("EnableScheme", "True"));
				NpcBuffer_EnableHeal = Boolean.parseBoolean(FidasSettings.getProperty("EnableHeal", "True"));
				NpcBuffer_EnableBuffs = Boolean.parseBoolean(FidasSettings.getProperty("EnableBuffs", "True"));
				NpcBuffer_EnableResist = Boolean.parseBoolean(FidasSettings.getProperty("EnableResist", "True"));
				NpcBuffer_EnableSong = Boolean.parseBoolean(FidasSettings.getProperty("EnableSongs", "True"));
				NpcBuffer_EnableDance = Boolean.parseBoolean(FidasSettings.getProperty("EnableDances", "True"));
				NpcBuffer_EnableChant = Boolean.parseBoolean(FidasSettings.getProperty("EnableChants", "True"));
				NpcBuffer_EnableOther = Boolean.parseBoolean(FidasSettings.getProperty("EnableOther", "True"));
				NpcBuffer_EnableSpecial = Boolean.parseBoolean(FidasSettings.getProperty("EnableSpecial", "True"));
				NpcBuffer_EnableCubic = Boolean.parseBoolean(FidasSettings.getProperty("EnableCubic", "True"));
				NpcBuffer_EnableCancel = Boolean.parseBoolean(FidasSettings.getProperty("EnableRemoveBuffs", "True"));
				NpcBuffer_EnableBuffSet = Boolean.parseBoolean(FidasSettings.getProperty("EnableBuffSet", "True"));
				NpcBuffer_EnableBuffPK = Boolean.parseBoolean(FidasSettings.getProperty("EnableBuffForPK", "False"));
				NpcBuffer_EnableFreeBuffs = Boolean.parseBoolean(FidasSettings.getProperty("EnableFreeBuffs", "True"));
				NpcBuffer_EnableTimeOut = Boolean.parseBoolean(FidasSettings.getProperty("EnableTimeOut", "True"));
				NpcBuffer_TimeOutTime = Integer.parseInt(FidasSettings.getProperty("TimeoutTime", "10"));
				NpcBuffer_MinLevel = Integer.parseInt(FidasSettings.getProperty("MinimumLevel", "20"));
				NpcBuffer_PriceCancel = Integer.parseInt(FidasSettings.getProperty("RemoveBuffsPrice", "100000"));
				NpcBuffer_PriceHeal = Integer.parseInt(FidasSettings.getProperty("HealPrice", "100000"));
				NpcBuffer_PriceBuffs = Integer.parseInt(FidasSettings.getProperty("BuffsPrice", "100000"));
				NpcBuffer_PriceResist = Integer.parseInt(FidasSettings.getProperty("ResistPrice", "100000"));
				NpcBuffer_PriceSong = Integer.parseInt(FidasSettings.getProperty("SongPrice", "100000"));
				NpcBuffer_PriceDance = Integer.parseInt(FidasSettings.getProperty("DancePrice", "100000"));
				NpcBuffer_PriceChant = Integer.parseInt(FidasSettings.getProperty("ChantsPrice", "100000"));
				NpcBuffer_PriceOther = Integer.parseInt(FidasSettings.getProperty("OtherPrice", "100000"));
				NpcBuffer_PriceSpecial = Integer.parseInt(FidasSettings.getProperty("SpecialPrice", "100000"));
				NpcBuffer_PriceCubic = Integer.parseInt(FidasSettings.getProperty("CubicPrice", "100000"));
				NpcBuffer_PriceSet = Integer.parseInt(FidasSettings.getProperty("SetPrice", "10000000"));
				NpcBuffer_PriceScheme = Integer.parseInt(FidasSettings.getProperty("SchemePrice", "10000000"));
				NpcBuffer_MaxScheme = Integer.parseInt(FidasSettings.getProperty("MaxScheme", "4"));
				NpcBuffer_consumableID = Integer.parseInt(FidasSettings.getProperty("ConsumableID", "57"));
				
				VOTE_SYSTEM_ENABLE = Boolean.parseBoolean(FidasSettings.getProperty("EnableVoteSystem", "True"));
				VOTE_SYSTEM_HOPZONE = Boolean.parseBoolean(FidasSettings.getProperty("VoteSystemHopzone", "true"));
				VOTE_SYSTEM_DATABASE_SAVE = Boolean.parseBoolean(FidasSettings.getProperty("SaveVotesIntoDataBase", "true"));
				VOTE_SYSTEM_PAGE = FidasSettings.getProperty("VoteSystemPage", "");
				VOTE_SYSTEM_COUNT = Integer.parseInt(FidasSettings.getProperty("VoteSystemVotes", "10"));
				VOTE_SYSTEM_START_TIME = Integer.parseInt(FidasSettings.getProperty("VoteSystemStartCheckTime", "60"));
				VOTE_SYSTEM_CHECK_TIME = Integer.parseInt(FidasSettings.getProperty("VoteSystemRunCheckTime", "120"));
				VOTE_SYSTEM_ITEM_ID = FidasSettings.getProperty("VoteSystemItemID", "57, 1000");
				VOTE_SYSTEM_ITEM_COUNT = FidasSettings.getProperty("VoteSystemItemCount", "1000, 1");
				ALLOW_REFUSE_BUFF = Boolean.parseBoolean(FidasSettings.getProperty("AllowRefuseBuff", "True"));
				MAX_PC_BANG_POINTS = Integer.parseInt(FidasSettings.getProperty("MaxPcBangPoints", "1000000000"));
				if (MAX_PC_BANG_POINTS < 0)
				{
					MAX_PC_BANG_POINTS = 0;
				}
				ENABLE_DOUBLE_PC_BANG_POINTS = Boolean.parseBoolean(FidasSettings.getProperty("DoublingAcquisitionPoints", "false"));
				DOUBLE_PC_BANG_POINTS_CHANCE = Integer.parseInt(FidasSettings.getProperty("DoublingAcquisitionPointsChance", "1"));
				if ((DOUBLE_PC_BANG_POINTS_CHANCE < 0) || (DOUBLE_PC_BANG_POINTS_CHANCE > 100))
				{
					DOUBLE_PC_BANG_POINTS_CHANCE = 1;
				}
				PC_BANG_POINT_RATE = Double.parseDouble(FidasSettings.getProperty("AcquisitionPointsRate", "1.0"));
				if (PC_BANG_POINT_RATE < 0)
				{
					PC_BANG_POINT_RATE = 1;
				}
				RANDOM_PC_BANG_POINT = Boolean.parseBoolean(FidasSettings.getProperty("AcquisitionPointsRandom", "false"));
				Boost_EXP_COMMAND = Boolean.parseBoolean(FidasSettings.getProperty("SpExpCommand", "True"));
				CMD_TRADE = Boolean.parseBoolean(FidasSettings.getProperty("CommandTrade", "True"));
				CMD_ONLINE = Boolean.parseBoolean(FidasSettings.getProperty("CommandOnline", "True"));
				CMD_FAKE = Boolean.parseBoolean(FidasSettings.getProperty("CommandFakePlayer", "True"));
				FAKE_PLAYERS = Integer.parseInt(FidasSettings.getProperty("NumberOfFakes", "1"));
				BOSS_STATS = Boolean.parseBoolean(FidasSettings.getProperty("GrandBossStats", "True"));

				PVPS_COLORS = FidasSettings.getProperty("PvpsColors", "");
				...
				PKS_COLORS = FidasSettings.getProperty("PksColors", "");
			...
			{
				_log.log(Level.SEVERE, "Error while loading L2Fidass settings!", e);
			}
			...
			ADD_CHAR_TITLE = Character.getProperty("CharAddTitle", "L2Fidas");
			...
			// sistema de AIO bufer
			ENABLE_AIO_SYSTEM = Boolean.parseBoolean(FidasSettings.getProperty("EnableAioSystem", "true"));
			ALLOW_AIO_NCOLOR = Boolean.parseBoolean(FidasSettings.getProperty("AllowAioNameColor", "true"));
			AIO_NCOLOR = Integer.decode("0x" + FidasSettings.getProperty("AioNameColor", "000000"));
			ALLOW_AIO_TCOLOR = Boolean.parseBoolean(FidasSettings.getProperty("AllowAioTitleColor", "true"));
			AIO_TCOLOR = Integer.decode("0x" + FidasSettings.getProperty("AioTitleColor", "000000"));
			AIO_ITEMID = Integer.parseInt(FidasSettings.getProperty("ItemIdAio", "2523"));
			ALLOW_AIO_ITEM = Boolean.parseBoolean(FidasSettings.getProperty("AllowAIOItem", "True"));
			if (ENABLE_AIO_SYSTEM) // create map if system is enabled
				{
				String[] AioSkillsSplit = FidasSettings.getProperty("AioSkills", "").split(";");
				...
				for (String skill : AioSkillsSplit)
				{
					...
					if (skillSplit.length != 2)
					{
						System.out.println("[VIP+ System]: invalid config property in L2Fidas.properties -> AioSkills \"" + skill + "\"");
					}
					else
					{
						try
						...
						catch (NumberFormatException nfe)
						{
							if (!skill.equals(""))
							{
								System.out.println("[VIP+ System]: invalid config property in L2Fidas.properties -> AioSkills \"" + skillSplit[0] + "\"" + skillSplit[1]);
							}
						}
					}
				}
			}
			ALLOW_VIP_NCOLOR = Boolean.parseBoolean(FidasSettings.getProperty("AllowVipNameColor", "True"));
			VIP_NCOLOR = Integer.decode("0x" + FidasSettings.getProperty("VipNameColor", "0088FF"));
			ALLOW_VIP_TCOLOR = Boolean.parseBoolean(FidasSettings.getProperty("AllowVipTitleColor", "True"));
			VIP_TCOLOR = Integer.decode("0x" + FidasSettings.getProperty("VipTitleColor", "0088FF"));
			ALLOW_VIP_EXP_SP = Boolean.parseBoolean(FidasSettings.getProperty("AllowVipMulExpSp", "True"));
			ALLOW_VIP_DROP = Boolean.parseBoolean(FidasSettings.getProperty("AllowVipMulDrop", "True"));
			ALLOW_VIP_ADENA = Boolean.parseBoolean(FidasSettings.getProperty("AllowVipMulAdena", "True"));
			ALLOW_VIP_SPOIL = Boolean.parseBoolean(FidasSettings.getProperty("AllowVipMulSpoil", "True"));
			VIP_XP = Float.parseFloat(FidasSettings.getProperty("VipMulXp", "1.20"));
			VIP_SP = Float.parseFloat(FidasSettings.getProperty("VipMulSp", "1.20"));
			VIP_ADENA = Float.parseFloat(FidasSettings.getProperty("VipMulAdena", "1.20"));
			VIP_DROP = Float.parseFloat(FidasSettings.getProperty("VipMulDrop", "1.20"));
			VIP_SPOIL = Float.parseFloat(FidasSettings.getProperty("VipMulSpoil", "1.20"));
			VIPPLUS_SPOIL = Float.parseFloat(FidasSettings.getProperty("VipPlusMulSpoil", "0.5"));
			
			System.out.println("[VIP-CONFIG] EXP_SP=" + ALLOW_VIP_EXP_SP
				    + " DROP=" + ALLOW_VIP_DROP
				    + " ADENA=" + ALLOW_VIP_ADENA
				    + " SPOIL=" + ALLOW_VIP_SPOIL
				    + " VIP_XP=" + VIP_XP
				    + " VIP_SP=" + VIP_SP
				    + " VIP_ADENA=" + VIP_ADENA
				    + " VIP_DROP=" + VIP_DROP
				    + " VIP_SPOIL=" + VIP_SPOIL
				    + " VIPPLUS_SPOIL=" + VIPPLUS_SPOIL);
			
			ENABLE_VIP_SYSTEM = Boolean.parseBoolean(FidasSettings.getProperty("EnableVipSystem", "True"));
			if(ENABLE_VIP_SYSTEM) //create map if system is enabled
			{
				String[] VipSkillsSplit = FidasSettings.getProperty("VipSkills", "").split(";");
			...
			// Comando de Teleporte para areas de UpLevel
			ALLOW_TELEPORT_VOICECOMMAND = Boolean.parseBoolean(FidasSettings.getProperty("UpLevel", "True"));
			//Enchant protect
			PROTECT_ENCHANT_ENABLE = Boolean.parseBoolean(FidasSettings.getProperty("EnchantProtectEnable", "true"));
			MAX_ENCHANT_LEVEL_PROTECT = Integer.parseInt(FidasSettings.getProperty("MaxEnchantLevelProtect", "30"));
			ENCHANT_PROTECT_PUNISH = Integer.parseInt(FidasSettings.getProperty("EnchantProtectPunish", "60"));
			CLAN_NAME_AS_TITLE = Boolean.parseBoolean(Character.getProperty("ClanTitle", "True"));
			PM_OFF = Boolean.parseBoolean(FidasSettings.getProperty("CommandPmOff", "True"));
			
			// Create macro newbie
			CREATE_NEWBIE_MACRO = FidasSettings.getProperty("CreateNewbieMacro", "").trim();
			
			// DressMe Colors
			DRESSME_COLOR_COIN_ID = Integer.parseInt(FidasSettings.getProperty("DressMeColorCoinId", "22600"));
			DRESSME_NAME_COLOR_PRICE = Long.parseLong(FidasSettings.getProperty("DressMeNameColorPrice", "5"));
			DRESSME_TITLE_COLOR_PRICE = Long.parseLong(FidasSettings.getProperty("DressMeTitleColorPrice", "5"));
			DRESSME_COLORS = FidasSettings.getProperty("DressMeColors", "00FF00");
			DRESSME_FREE_COLORS = FidasSettings.getProperty("DressMeFreeColors", "FFFFFF");

			// DressMe Armor
			DRESSME_ARMOR_COIN_ID = Integer.parseInt(FidasSettings.getProperty("DressMeArmorCoinId", "22600"));
			DRESSME_ARMOR_PRICE = Long.parseLong(FidasSettings.getProperty("DressMeArmorPrice", "20"));
			
			// DressMe Sex
			DRESSME_SEX_COIN_ID = Integer.parseInt(FidasSettings.getProperty("DressMeSexCoinId", "22600"));
			DRESSME_SEX_PRICE = Long.parseLong(FidasSettings.getProperty("DressMeSexPrice", "5"));

			// DressMe Name
			DRESSME_NAME_CHANGE_COIN_ID = Integer.parseInt(FidasSettings.getProperty("DressMeNameChangeCoinId", "22600"));
			DRESSME_NAME_CHANGE_PRICE = Long.parseLong(FidasSettings.getProperty("DressMeNameChangePrice", "5"));
			...
			GLOBAL_CHAT_MIN_LEVEL = Integer.parseInt(General.getProperty("GlobalChatMinLevel", "40"));
			if (GLOBAL_CHAT_MIN_LEVEL < 0)
			{
				GLOBAL_CHAT_MIN_LEVEL = 0;
			}
			TRADE_CHAT_MIN_LEVEL = Integer.parseInt(General.getProperty("TradeChatMinLevel", "40"));
			if (TRADE_CHAT_MIN_LEVEL < 0)
			{
				TRADE_CHAT_MIN_LEVEL = 0;
			}
			...
			WELCOME_MESSAGE_TEXT = L2JModSettings.getProperty("ScreenWelcomeMessageText", "Welcome to the World of Lineage II");
	...
	public static boolean setParameterValue(String pName, String pValue)
	{
		switch (pName.trim().toLowerCase())
		{
			...
			case "tradechat":
				...
				break;
			case "globalchatminlevel":
				GLOBAL_CHAT_MIN_LEVEL = Integer.parseInt(pValue);
				if (GLOBAL_CHAT_MIN_LEVEL < 0)
				{
					GLOBAL_CHAT_MIN_LEVEL = 0;
				}
				break;
			case "tradelchatminlevel":
				TRADE_CHAT_MIN_LEVEL = Integer.parseInt(pValue);
				if (TRADE_CHAT_MIN_LEVEL < 0)
				{
					TRADE_CHAT_MIN_LEVEL = 0;
				}
	...
	private static void loadFloodProtectorConfigs(final L2Properties properties)
	{
		...
		loadFloodProtectorConfig(properties, FLOOD_PROTECTOR_VIP_CHAT, "VipChat", "3");
