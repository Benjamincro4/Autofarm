...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see fidas.server.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link fidas.server.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see fidas.server.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see fidas.server.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see fidas.server.util.Rnd#get(int n)
	 */
