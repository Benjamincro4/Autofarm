...
import fidas.server.gameserver.datatables.MerchantPriceConfigTable.MerchantPriceConfig;
...
public class AdminEditNpc implements IAdminCommandHandler
{
	...
	private void saveNpcProperty(L2PcInstance activeChar, String command)
	{
		...
		try
		{
			...
			{
				Class.forName("fidas.server.gameserver.model.actor.instance." + value + "Instance");
