...
from fidas.server.gameserver.datatables import ClassListData
from fidas.server.gameserver.model.base         import ClassType
from fidas.server.gameserver.model.base         import Race
