...
import fidas.server.gameserver.model.quest.jython.QuestJython;
	...
	public static void main(String[] args)
	{
		...
		for (int level = 1; level < 100; level++)
		{
			...
			for (L2NpcTemplate t : templates)
			{
				try
				{
					if (L2Attackable.class.isAssignableFrom(Class.forName("fidas.server.gameserver.model.actor.instance." + t.getType() + "Instance")))
					{
